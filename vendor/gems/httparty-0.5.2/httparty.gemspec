...
Gem::Specification.new do |s|
  ...
  s.authors = ["John Nunemaker", "Sandro Turriate", "Brian Cardarella", "Wes Morgan"]
  s.date = %q{2010-05-13}
  s.default_executable = %q{httparty}
  s.description = %q{Makes http fun! Also, makes consuming restful web services dead easy. This is the DNC bugfix fork.}
