class AuthenticationController < ApplicationController
  ...
  def show
    if partner = Partner.authenticate(params[:id])
      ...
      headers.merge!({'X-RateLimit-Limit' => partner.max_requests.to_s, 'X-RateLimit-Remaining' => partner.requests_remaining.to_s, 'X-RateLimit-Reset' => partner.max_requests_reset.to_s}) unless partner.max_requests.nil?
